...
{
    [EventSource(Name = "MyCompany-PipServices.Dummy.Application-StatelessService")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [NonEvent]
        public void ServiceMessage(DummyStatelessService service, string message, params object[] args)
        {
            if (this.IsEnabled())
            {
                string finalMessage = string.Format(message, args);
