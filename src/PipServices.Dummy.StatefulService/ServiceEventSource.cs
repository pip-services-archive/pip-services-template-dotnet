...
{
    [EventSource(Name = "MyCompany-PipServices.Dummy.Application-StatefulService")]
    internal sealed class ServiceEventSource : EventSource
    {
        ...
        [NonEvent]
        public void ServiceMessage(DummyStatefulService service, string message, params object[] args)
        {
            if (this.IsEnabled())
            {
                string finalMessage = string.Format(message, args);
