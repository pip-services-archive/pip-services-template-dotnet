...
{
    [EventSource(Name = "MyCompany-PipServices.Dummy.Application-PipServices.Dummy.Actor")]
    internal sealed class ActorEventSource : EventSource
    {
        ...
        [NonEvent]
        public void ActorMessage(DummyActor actor, string message, params object[] args)
        {
            if (this.IsEnabled()
                && actor.Id != null
